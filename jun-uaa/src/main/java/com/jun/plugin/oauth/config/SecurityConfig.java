...
import com.jun.plugin.oauth.filter.LoginProcessSetTenantFilter;
import com.jun.plugin.oauth.mobile.MobileAuthenticationSecurityConfig;
import com.jun.plugin.oauth.password.PasswordAuthenticationProvider;
import com.jun.plugin.oauth.service.impl.UserDetailServiceFactory;
import com.jun.plugin.oauth.tenant.TenantAuthenticationSecurityConfig;
import com.jun.plugin.oauth.tenant.TenantUsernamePasswordAuthenticationFilter;
import com.jun.plugin.oauth.openid.OpenIdAuthenticationSecurityConfig;
import com.jun.plugin.common.config.DefaultPasswordConfig;
